...
# (wireplumber) also backs the volume keybinds inherited from upstream's example
# config. All are in main except firmware-sof-signed (non-free-firmware, already
