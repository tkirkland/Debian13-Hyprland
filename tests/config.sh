...
assert_eq "wayland wayland-protocols xkbcommon hyprwayland-scanner hyprutils hyprlang hyprcursor hyprgraphics hyprland-protocols aquamarine hyprland uwsm" \
